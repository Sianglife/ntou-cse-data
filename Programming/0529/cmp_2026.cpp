...
class Date2026 {
    ...
    public: 
        ...
        int compare(Date2026 other) {
            if (this->m < other.m || (this->m == other.m && this->d < other.d)) {
                return -1;
            } else if (this->m > other.m || (this->m == other.m && this->d > other.d)) {
                return 1;
            } else {
                return 0;
            }
